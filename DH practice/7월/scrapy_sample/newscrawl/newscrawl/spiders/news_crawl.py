...
class news_crawlSpider(scrapy.Spider):
    ...
    def parse_details(self, response):  
        ...
        if 'news.naver.com' in response.url:
            if str(response.xpath("//div[@class= 'press_logo']/a/img/@title").get()) == '연합인포맥스':#(str(response.xpath("//div[@class= 'press_logo']/a/img/@title").get()) == '연합뉴스')  or (str(response.xpath("//div[@class= 'press_logo']/a/img/@title").get()) == '이데일리'):#or 
